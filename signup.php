    ...
    ?>
  	<div class="register-box-body">
    	...
    	<form action="register.php" method="POST">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" name="repassword" placeholder="Điền lại mật khẩu" required>
          ...
          <hr>
      		<div class="row">
    			<div class="col-xs-4">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" name="signup"><i class="fa fa-pencil"></i> Đăng kí</button>
        		</div>
      		</div>
    	</form>
      <br>
